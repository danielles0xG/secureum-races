...
/** 
 *  SourceUnit: /Users/danielguerrero/workspace/INFOSEC/secureum-races/Slot8.sol
*/
...
contract InSecureumNFT {
    ...
    uint public constant saleDuration = 13 * 13337; // 1 3337 blocks assuming 13s block times
    ...
    function _mint(address _to) internal isPaused returns (uint) {
